                    ...
                    <form role="form" action="" method="POST">
                        ...
                        <tr>
                          ...
                          <td></td>
  						        	...
  						        	<tr>
                        <tr>
                          <th width="800">Pendapatan Jasa</th>
                          <td align="right">
                            <div style="float:left;">Rp</div>
                        ...
                        <tr>
                          ...
                          <td align="right">
                            <div style="float:left;">Rp</div>
                            <?php echo number_format($jml_pendapatan = $sum_penjumlahan['penjualan'] + $sum_pen['pendapatan'],2,',','.'); ?> &nbsp;
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
  						        		<th width="800">Harga Pokok Penualan</th>
                          <td></td>
  						        		<td align="right">
  						        			<u><div style="float:left;">Rp</div>
  						        			(<?php echo number_format($sum_hpp['hpp'],2,',','.'); ?>) &nbsp; </u>
  						        		</td>
  						        	</tr>
  						        	<tr>
                        ...
                        <tr>
                          <th width="800">Beban Perlengkapan</th>
                          <td align="right">
                            <div style="float:left;">Rp</div>
                          ...
                          <td></td>
  						        	...
  						        	<tr>
  						        		<th width="800">Total Beban Operasional</th>
                          <td></td>
  						        		<td align="right">
  						        			<u><div style="float:left;">Rp</div>
  						        			(<?php echo number_format($total_bu = $sum_listrik['listrik'] + $sum_telpon['telpon'] + $sum_peralatan['peralatan'] + $sum_gj['gj'],2,',','.'); ?>) &nbsp; </u>
  						        		</td>
  						        	</tr>
    						   			<tr class="danger">
  						        		<th width="800"><b>Laba</b></th>
                          <td></td>
  						        		<td align="right">
  						        			<div style="float:left;">Rp</div>
  						        			<?php echo number_format($total_lk - $total_bu,2,',','.'); ?>&nbsp;&nbsp;&nbsp;
  						        		</td>
  						        	</tr>
  						        </table>
  						        <?php
