<?php
include "../sesi.php";
$qperbaikan="SELECT * FROM perbaikan where pembayaran like 'lunas'";
                ...
                <div class="page-header">
    							<h1>
    								...
    								<small>
    									...
    									Tabel Daftar Jasa Perbaikan Telah Lunas
    								</small>
    							</h1>
    						</div><!-- /.page-header -->
    						...
    						<div class="row">
                              ...
                              <?php
                                while($row=mysql_fetch_assoc($rperbaikan)){
																...
																$rmontir=mysql_fetch_array(mysql_query("select nama_montir from montir where id_montir=$jasa"));
...
var o = document.getElementById("pembayaran");
o.className += "active ";
o.className += "open ";
