<?php
include "../sesi.php";
$qperbaikan="SELECT * FROM perbaikan where status = 'sudah'";
                ...
                <div class="page-header">
    							<h1>
    								...
    								<small>
    									...
    									Tabel Daftar Jasa Perbaikan Yang Sudah Selesai
    								</small>
    							</h1>
    						</div><!-- /.page-header -->
                              ...
                              ?>
    													<tr>
    														...
    														<td><?=$row['jam_selesai']?></td>
																<td class="hidden-480"><?=$rmontir['nama_montir']?></td>
    														<td>
																		...
																		<div class="modal-dialog">
																			<div class="modal-content">
																				...
																				<div class="modal-body no-padding">
																					<?php
																					$jasa=$row['id_jasa'];
																					$qnota="SELECT jenis,nama_barang,merk,harga,kwantitas,total,data_nota.tipe FROM nota,data_nota where nota.id_nota = data_nota.id_nota and id_transaksi = 1 AND nota.tipe != 'pembelian'";
																					...
																					<table class="table table-striped table-bordered table-hover no-margin-bottom no-border-top">
																						...
																						<tbody>
																							...
																							<tr>
																								<td colspan="5" align="right">DP</td>
																								<td align="right"><?=$row['dp']?></td>
																								<td align="center"></td>
																							</tr>
																							<tr>
																								<td colspan="5" align="right">TOTAL</td>
																								<td align="right"><?=$total=$subtotal+($subtotal/10)-$row['dp']?></td>
																								<td align="center"></td>
																							</tr>
																						</tbody>
																					</table>
																	...
																	<div class="action-buttons">
																		...
																		<a class="grey" href="cetak.php?jasa=<?=$jasa?>">
																			<i class="ace-icon fa fa-print bigger-130"></i>
																			<span class="hidden-sm hidden-xs">Cetak Nota</span>
																		</a>
																	</div>
    														</td>
    													</tr>
...
z.className += "active ";
z.className += "open ";
var t = document.getElementById("sudah-perbaikan");
t.className += "active ";
