                ...
                <div class="page-header">
    						...
    						<div class="row">
                                ...
                                <th>No</th>
    														<th>ID Penjualan</th>
    														<th>Tanggal</th>
    														<th class="hidden-480">Jenis Sparepart</th>
    														<th class="hidden-480">Id Sparepart</th>
																<th>Nama aparepart</th>
                                <th>Merk</th>
																<th>Tipe</th>
                                <th>Qty</th>
                                <th>Harga</th>
                              ...
                              <?php
                                  ...
                                  $i++;
                              	   ...
                              	   <td align="center"><?php echo $row['id_penjualan'];?></td>
                              		<td align="center"><?php echo $row['tanggal'];?></td>
                              		<td align="center"><?php echo $row['jenis_sparepart'];?></td>
                                  <td align="center"><?php echo $row['id_sparepart'];?></td>
                              		<td align="center"><?php echo $row['nama_sparepart'];?></td>
