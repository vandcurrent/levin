...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Data Pegawai - Levin Motor</title>
    						...
    						<div class="row">
    							<div class="col-xs-12">
    								<!-- PAGE CONTENT BEGINS -->
    										...
    										<div>
                          <form method="POST" action="proses-edit-pegawai.php">
    											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
    												<thead>
    													<tr>
    														<th>ID Pegawai</th>
    														<th>Nama pegawai</th>
    														<th class="hidden-480">Alamat pegawai</th>
                              ...
                              <?php
														  while($row=mysql_fetch_array($result)){
														    $jno=strlen($row["id_pegawai"]);
														                      ...
														                      elseif($jno=4)
														                      { $no=''; }
														    $fixid = 'PG'.$no.$row["id_pegawai"];
														    $i++;
																if ($row["level"]==01) {
																	$level = 'Costumer Service';
																}else
																if ($row["level"]==02) {
																	$level = 'Gudang';
																}else
                                ...
                                if ($row["level"]==05) {
                                  $level = 'Pemilik';
                              		...
                              		<td align="center"><?php echo $row['alamat_pegawai'];?></td>
                              		<td align="center"><?php echo $row['telpon_pegawai'];?></td>
                              		<td align="center"><?php echo $level;?></td>
                              		<td align="center"><?php echo $row['status'];?></td>
																	<td align="center">
																		<div class="action-buttons">
																			<a class="blue" href="ubah-pegawai.php?id=<?=$row["id_pegawai"]?>">
																				<i class="ace-icon fa fa-pencil bigger-130"></i>
																				<span class="hidden-sm hidden-xs">Edit</span>
																			</a>

																			<a class="red" href="hapus-pegawai.php?id=<?=$row["id_pegawai"]?>">
...
o.className += "active ";
o.className += "open ";
var o = document.getElementById("data-pegawai");
o.className += "active ";
