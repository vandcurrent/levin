<?php
include "../sesi.php";
$qperbaikan="SELECT * FROM perbaikan where pembayaran like 'belum' AND status = 'sudah'";
                ...
                <div class="page-header">
    							<h1>
    								...
    								<small>
    									...
    									Tabel Daftar Jasa Perbaikan Belum Lunas
    								</small>
    							</h1>
    						</div><!-- /.page-header -->
                                          ...
                                          <form method="POST" action="proses_bayar.php">
                                                ...
                                                $x = 0;
                                                  ...
                                                  $x++;
																							?>
																							<tr>
																								<td><?=$baris['nama_barang']?><input type="hidden" name="keterangan[]" value="<?=$baris['nama_barang'];?>"></td>
																								<td>
                                                  <?=$baris['merk']?>
                                                  <input type="hidden" name="jenis[]" value="<?=$baris['jenis'];?>">
                                                  <input type="hidden" name="merk[]" value="<?=$baris['merk'];?>">
                                                </td>
																								<td><?=$baris['kwantitas']?><input type="hidden" name="q[]" value="<?=$baris['kwantitas'];?>"></td>
																								<td align="right"><?=$baris['harga']?><input type="hidden" name="harga[]" value="<?=$baris['harga'];?>"></td>
																								<td align="right"><?=$baris['total']?><input type="hidden" name="atotal[]" value="<?=$baris['total'];?>"></td>
																								<td><?=$baris['tipe']?><input type="hidden" name="tipe[]" value="<?=$baris['tipe'];?>"></td>
																							</tr>
																							<?php
																							...
																							<tr>
																								...
																								<td style="padding:0;vertical-align: middle;">
																										...
																										<input type="hidden" name="total" value="<?=$total-$dp?>">
                                                    
                                                    <input type="hidden" name="row" value="<?=$x;?>">
                                                    
                                                    
                                                    <input type="hidden" name="ppn" value="<?=$subtotal/10;?>">
                                                    <input type="hidden" name="dp" value="<?=$dp?>">
																	...
																	<div class="action-buttons">
																		<a class="green" href="#modal-table-<?=$row['id_jasa']?>" data-toggle="modal">
																			<i class="ace-icon fa fa-money bigger-130"></i>
																			<span class="hidden-sm hidden-xs">Bayar</span>
																		</a>
                                    <a class="grey" href="faktur.php?jasa=<?=$jasa."&dp=".$dpkirim;?>">
...
var o = document.getElementById("belum-lunas");
o.className += "active ";
o.className += "open ";
