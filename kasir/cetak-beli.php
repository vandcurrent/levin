...
<div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-body no-padding">
      <?php
      $qnota="SELECT id_data,nama_barang,tgl_transaksi,jenis,merk,harga,kwantitas,total,tgl_lunas,data_nota.tipe FROM nota,data_nota where nota.id_nota = data_nota.id_nota and nota.id_nota = $jasa";
        ...
        <tfoot>
          ...
          <tr>
            ...
            <td colspan="2" align="center" style="border:none;"><u>
              <?php
                $rnama=mysql_fetch_array(mysql_query("SELECT nama_supplier FROM supplier, pembelian WHERE pembelian.id_supplier = supplier.id_supplier and pembelian.no_nota='$jasa'"));
                echo $rnama[0];
              ?>
            </u></td>
          </tr>
