<?php
include "../sesi.php";
$qperbaikan="SELECT * FROM pembelian where status like 'lunas'";
                ...
                <div class="page-header">
                  <h1>
                    ...
                    <small>
                      ...
                      Tabel Daftar Pembelian Telah Lunas
                    </small>
                  </h1>
                </div><!-- /.page-header -->
                          ...
                          <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                              <?php
                                ...
                                $rlunas=mysql_fetch_array(mysql_query("select tgl_lunas from nota where id_nota=$jasa"));
                              ?>
                              <tr>
                                <td><?=$row['no_nota']?></td>
                                ...
                                <td>
                                      ...
                                      <div class="modal-content">
                                        <div class="modal-header no-padding">
                                          <div class="table-header">
                                            ...
                                            Tabel No Nota Dari ID Jasa: <?=$row['no_nota']?>
                                          </div>
                                        </div>
                                        <div class="modal-body no-padding">
                                          <?php
                                          $qnota="SELECT id_data,nama_barang,jenis,merk,harga,kwantitas,total,data_nota.tipe FROM nota,data_nota where nota.id_nota = data_nota.id_nota and nota.id_nota = '$jasa' and nota.tipe = 'pembelian'";
                                  ...
                                  <div class="action-buttons">
                                    ...
                                    <a class="grey" href="cetak-beli.php?jasa=<?=$jasa?>">
...
var o = document.getElementById("lunas");
o.className += "active ";
o.className += "open ";
