<?php
include "../sesi.php";
$qperbaikan="SELECT * FROM pembelian where status like 'belum'";
                ...
                <div class="page-header">
                  <h1>
                    ...
                    <small>
                      ...
                      Tabel Daftar Pembelian Sparepart Belum Lunas
                    </small>
                  </h1>
                </div><!-- /.page-header -->
                              ...
                              <tr>
                                ...
                                <td>
                                      ...
                                      <div class="modal-content">
                                        <div class="modal-header no-padding">
                                          <div class="table-header">
                                            ...
                                            Tabel Nota Pembelian Sparepart Dari Nota: <?=$row['no_nota']?>
                                          </div>
                                        </div>
                                        <div class="modal-body no-padding">
                                          <?php
                                          $pembelian = $row['no_nota'];
                                          //echo $pembelian;
                                          $qnota="SELECT id_data,nama_barang,jenis,merk,harga,kwantitas,total,data_nota.tipe FROM nota,data_nota where nota.id_nota = data_nota.id_nota and nota.id_nota = $pembelian and nota.tipe = 'pembelian' AND nota.jenis != 'pembelian'";
                                          ...
                                          <table class="table table-striped table-bordered table-hover no-margin-bottom no-border-top">
                                            ...
                                            <tbody>
                                              ...
                                              <tr>
                                                <td colspan="4" align="right">DPQ</td>
                                              ...
                                              <tr>
                                                ...
                                                <form method="POST" action="proses_bayar-beli.php">
                                  ...
                                  <div class="action-buttons">
                                    ...
                                    <a class="grey" href="faktur-beli.php?jasa=<?=$jasa."&dp=".$dp;?>">
